...
<!-- End BuySellAds Zone Code -->
	...
	<div id="wrapper">
		<div id="postswrapper1" class="common">
...
<div id="loadmoreajaxloader" style="display:none;"><center><img src="http://www.jquery4u.com/demos/infinite-scrolling-demo2/ajax-loader.gif" /></center></div>
		...
		$(window).scroll(function(){
			...
			if (st > lastScrollTop)
			{
			  	...
			  	divArray.each(function(){
					...
					if($(id1).visible(true)&&$(id2).visible(true)&&lastDivScrolled.indexOf(id2)==-1 )
					{
						//alert('new page loaded....'+id2);
						lastDivScrolled=id2;
						$.ajax({
							url: "test8.jsp",
			   ...
			   else 
			   {
			   		...
			   		divArray.each(function(){
						var id1="#"+this.id;
						var id2='#'+$(this).next().attr('id');
						if($(id1).visible(true)&&$(id2).visible(true)&&lastDivScrolled.indexOf(id1)==-1 )
							{
								//alert('new page loaded....'+id1);
								lastDivScrolled=id1;	
								$.ajax({
									url: "test8.jsp",
									success: function(html){
